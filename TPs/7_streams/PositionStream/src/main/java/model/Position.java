...
public class Position extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 8093017406612337158L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Position\",\"namespace\":\"model\",\"fields\":[{\"name\":\"latitude\",\"type\":\"double\"},{\"name\":\"longitude\",\"type\":\"double\"}]}");
   ...
   */
  public static model.Position.Builder newBuilder() {
    return new model.Position.Builder();
  }
   ...
   * @return A new Position RecordBuilder
   */
  public static model.Position.Builder newBuilder(model.Position.Builder other) {
    return new model.Position.Builder(other);
  }
   ...
   * @return A new Position RecordBuilder
   */
  public static model.Position.Builder newBuilder(model.Position other) {
    return new model.Position.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Position>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(model.Position.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(model.Position other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.latitude)) {
        this.latitude = data().deepCopy(fields()[0].schema(), other.latitude);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public model.Position.Builder setLatitude(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public model.Position.Builder clearLatitude() {
    ...
    /**
      ...
      * @return This builder.
      */
    public model.Position.Builder setLongitude(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public model.Position.Builder clearLongitude() {
