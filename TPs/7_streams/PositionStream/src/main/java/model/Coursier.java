...
public class Coursier extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 7339741433623195165L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Coursier\",\"namespace\":\"model\",\"fields\":[{\"name\":\"id\",\"type\":\"long\"},{\"name\":\"position\",\"type\":[{\"type\":\"record\",\"name\":\"Position\",\"fields\":[{\"name\":\"latitude\",\"type\":\"double\"},{\"name\":\"longitude\",\"type\":\"double\"}]}]}]}");
   ...
   */
  public static model.Coursier.Builder newBuilder() {
    return new model.Coursier.Builder();
  }
   ...
   * @return A new Coursier RecordBuilder
   */
  public static model.Coursier.Builder newBuilder(model.Coursier.Builder other) {
    return new model.Coursier.Builder(other);
  }
   ...
   * @return A new Coursier RecordBuilder
   */
  public static model.Coursier.Builder newBuilder(model.Coursier other) {
    return new model.Coursier.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Coursier>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(model.Coursier.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(model.Coursier other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public model.Coursier.Builder setId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public model.Coursier.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public model.Coursier.Builder setPosition(java.lang.Object value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public model.Coursier.Builder clearPosition() {
      position = null;
